...
class ControllerIndex{
	...
	function __construct()
	{
		...
		$data['urlWMSqgis']	= $this->_system->get('urlWMSqgis_ortofotos_historial');

		$detect 			= new Mobile_Detect();
		$data['isMobile'] 	= ($detect->isMobile() === true && $detect->isTablet() === false)? '1' : '0';

		// set to POUM by default
		$data['mapid'] = "ortofotos_historial";
		$data['mapname'] = "Ortofotos historial";
		$data['title'] = "L'ull del temps";
